...
//
//        // Draw background
//        canvas.drawRect(0, 0, width, sliderHeight, backgroundPaint);
//
//        // Draw green filled portion
//        float filledHeight = fillFraction * sliderHeight;
//        canvas.drawRect(0, sliderHeight - filledHeight, width, sliderHeight, fillPaint);
//    }
//
//    @Override
...
//                fillFraction = 1f - Math.max(0f, Math.min(y / sliderHeight, 1f));
//                invalidate();
//                return true;
//        }
...
//
//    /**
//     * Optional: allow other classes to get the current fill value (0..1)
//     */
...
//
//    /**
//     * Optional: set fill programmatically (0..1)
//     */
